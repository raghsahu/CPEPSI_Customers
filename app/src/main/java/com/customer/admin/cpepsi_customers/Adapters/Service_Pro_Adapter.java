...
public class Service_Pro_Adapter extends RecyclerView.Adapter<Service_Pro_Adapter.MyViewHolder> {
    ...
    public Service_Pro_Adapter(Activity activity, ArrayList<ApiModel> services) {
        mContext = activity;
