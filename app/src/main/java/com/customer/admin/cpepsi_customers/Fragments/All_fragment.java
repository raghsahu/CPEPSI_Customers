...
public class All_fragment extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View allView = inflater.inflate(R.layout.activity_all_fragment, container, false);
...
//************************************************************************************
    ...
    public class PostNotification extends AsyncTask<String, Void, String> {
            ...
            if (result != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        noti_list.add(i,new NotificationModel(pr_id, customer_id, provider_id, discription, date,Prostatus,user_id
        ...
        private class PmostNotification {
        }
    }
}
//*********************************************************************